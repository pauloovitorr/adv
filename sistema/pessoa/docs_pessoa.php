...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['file'])) {
    ...
    try {
        if ($tamanhoArquivo > 3 * 1024 * 1024) {
            $res = [
                'status' => 'erro',
                'message' => 'Documento muito grande! Tamanho máximo permitido de 2MB'
            ];
            ...
            if (move_uploaded_file($temp_name, $caminho)) {
                ...
                if ($stmt->execute()) {
                    ...
                    if (cadastro_log('Cadastrou Documento na Pessoa', $nome_arquivo, $ip, $id_user)) {
                        ...
                        $res = [
                            'status' => 'erro',
                            'message' => 'Erro ao cadastrar documento, tente novamente em alguns minutos!'
                        ];
